...
/**
 * Represents the percentage of instances covered by a rule of the induced set of rules.
 * @author Marta
 *
 */
public class Coverage extends Fitness implements OptionHandler, StartSetHandler{
