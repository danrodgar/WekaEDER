...
import weka.subgroupDiscovery.edersd.operator.crossover.Crossover;
import weka.subgroupDiscovery.edersd.operator.crossover.Crossover1;
import weka.core.*;
...
public class FunctionFitnessNormal extends Fitness implements OptionHandler, StartSetHandler{
	...
	public double fitness(ArrayList<Instance> exampleSet,
			EDERSD_Rule rule, Random randomGenerator,double totalVolume, double errorPercentage) {
...
//		System.out.println(rule.printRule());
//		System.out.println("ERROR: "+error);
//		System.out.println("nCOND: "+nCond);
//		
//		System.out.println("---------------");
