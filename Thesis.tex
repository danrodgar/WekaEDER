...
\input{Chapters/Chapter2} % Weka

\input{Chapters/Chapter3} % R Environment

\input{Chapters/Chapter4} % Rapidminer

\input{Chapters/Chapter5} % KNIME

\input{Chapters/Chapter6} % JCLEC

\input{Chapters/Chapter7} % Keel

\input{Chapters/Chapter8} % Cortana

\input{Chapters/Chapter9} % Orange

\input{Chapters/Chapter10} % Conclusions & Feature Work
...
\input{Appendices/AppendixA}	% Learning resources
