 ...
 * @version $Revision: 6904 $
 */
public class SubgroupDiscoveryErrorsPlotInstances
  ...
  protected SubgroupDiscovery m_SD;
   ...
   */
  public void setClassifier(SubgroupDiscovery value) {
    m_SD = value;
  }
   ...
   */
  public SubgroupDiscovery getSD() {
    return m_SD;
  }
  ...
  protected void addPredictionIntervals() {
    ...
    maxNum = 0;
    preds  = (FastVector) m_Evaluation.predictions();
  ...
  protected void finishUp() {
    ...
    if (m_Instances.attribute(m_ClassIndex).isNumeric()) {
      ...
      if (m_SD instanceof IntervalEstimator)
