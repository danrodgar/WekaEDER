...
/**
 * Refers to the radio between the number of instances satisfying both the 
 * antecedent and the consequent part of a rule and the total number of instances.
 *  
 * @author Marta
 *
 */
public class Support extends Fitness implements OptionHandler, StartSetHandler{
