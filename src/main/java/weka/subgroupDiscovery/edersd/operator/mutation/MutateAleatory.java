...
public class MutateAleatory extends Mutation implements OptionHandler, StartSetHandler
{
	 ...
	 */
	public EDERSD_Rule doMutation(int m_NumAttributes,int classIndex,EDERSD_Rule rule,EDERSD_Rule ruleMaxMin,Random randomGenerator) 
	{			
		int p = classIndex;
		float prob;
...
//		System.out.println("Regla: "+rule.printRule());
...
//		System.out.println("Regla mutada: "+rule.printRule());
