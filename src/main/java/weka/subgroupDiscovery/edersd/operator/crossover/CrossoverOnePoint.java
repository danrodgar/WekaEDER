...
public class CrossoverOnePoint extends Crossover implements OptionHandler, StartSetHandler
{
	 ...
	 * @throws Exception 
	 */
	  public EDERSD_Rule doCrossover(Instances dataSetInstances, EDERSD_Rule parent1,EDERSD_Rule parent2,Random randomGenerator) throws Exception 
	  {
		  int m_NumAttributes=dataSetInstances.numAttributes();
		  int puntoCruce;   //Point of crossover
		  
		  //To generate two EDERSD_Rule children	       
