 ...
 */
public class MutateAleatory extends Mutation implements OptionHandler, StartSetHandler
{
	/**
	 * Constructor.
	 */
	public MutateAleatory(){}
    
	/**
	 * Mutates a given individual.
	 * @param individual Individual to be mutated.
	 */
	public HIDER_Rule doMutation(int m_NumAttributes,int classIndex,HIDER_Rule rule,HIDER_Rule ruleMaxMin,Random randomGenerator) 
	{			
		int p = classIndex;
		float prob;
	...
	public Object execute(Object object) {
		HIDER_Rule solution= (HIDER_Rule) object;
	  
		int m_NumAttributes=(Integer)getParameter("numAttributes");
		int classIndex=(Integer)getParameter("classIndex");
		HIDER_Rule ruleMaxMin = (HIDER_Rule) getParameter("ruleMaxMin");
		Random randomGenerator=(Random)getParameter("random");
			    	    	    	    	    	
	    HIDER_Rule offSpring;
	    offSpring = doMutation(m_NumAttributes,classIndex,solution,ruleMaxMin,randomGenerator);
