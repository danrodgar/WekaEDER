...
import weka.classifiers.rules.hider.evaluation.Fitness;
import weka.classifiers.rules.hider.evaluation.FunctionFitnessNormal;
...
public class Mutate1 extends Mutation implements OptionHandler, StartSetHandler
{
	 ...
	 */
	public HIDER_Rule doMutation(int m_NumAttributos,int classIndex,HIDER_Rule rule,HIDER_Rule ruleMaxMin,Random randomGenerator) 
	{	
		int p = classIndex;
		double anterior;
