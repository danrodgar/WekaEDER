...
public class Crossover1 extends Crossover implements OptionHandler, StartSetHandler{
	...
	public EDERSD_Rule doCrossover(Instances dataSetInstances,
			EDERSD_Rule parent1, EDERSD_Rule parent2, EDERSD_Rule son) throws Exception {
		...
		if (parent1.getRuleClass() == parent2.getRuleClass()) {
			EDERSD_Rule rule = new EDERSD_Rule(parent1.getRuleClass());
