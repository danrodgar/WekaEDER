...
import weka.subgroupDiscovery.edersd.operator.mutation.Mutate1;
import weka.subgroupDiscovery.edersd.operator.mutation.Mutation;
 ...
 */
public class RouletteWheel extends Selection implements OptionHandler, StartSetHandler{
	 ...
	 * 
	 * @param object An object containing an array of two EDERSD_Rule
